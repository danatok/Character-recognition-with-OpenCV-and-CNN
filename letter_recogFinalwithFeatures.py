...
'''
"letter_recog" file from opencv
MLP does not support categorical variables, so instead of the output class label
...
if __name__ == '__main__':
    ...
    args.setdefault('--save','model_letter.txt') #name of the model when saving it

    datafile = "output_features.txt"  #the training set
    ...
    if '--load' in args:     #take this part of the code to load the model in facedetect
        fn = args['--load']
    ...
    if '--save' in args:     #to save the model
        fn = args['--save']
